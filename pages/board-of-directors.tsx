...

      {
        ...
        description: (
          <>
            ...
            <p>
  As one of the youngest CEOs in a multinational corporation in Bangladesh, Mr. Rokonuzzaman has been leading AMANN Bangladesh since October 2016. Prior to this role, he served as Finance Director and Company Secretary from the company&apos;s inception in Bangladesh. His dynamic leadership has enabled AMANN to establish a strong foothold in the Sewing Threads Industry in a remarkably short time.
</p>
            <p>
